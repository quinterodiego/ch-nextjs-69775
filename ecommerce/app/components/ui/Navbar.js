...
export const Navbar = () => {
  ...
  const { productsQuantity } = useCartContext()
          ...
          <Link href={'/carrito'} className='hover:opacity-75 relative'>
            <div className="relative py-2">
              <div className="t-0 absolute left-3">
                <p className="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-3 text-xs text-white">{productsQuantity}</p>
              </div>
